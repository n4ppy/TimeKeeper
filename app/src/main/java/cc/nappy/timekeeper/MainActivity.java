...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_close_all) {
            ...
            Snackbar.make(findViewById(R.id.drawer_layout), "Report this month", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        } else if (id == R.id.nav_last_month) {
            Snackbar.make(findViewById(R.id.drawer_layout), "Report last month", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        } else if (id == R.id.nav_all) {
            Snackbar.make(findViewById(R.id.drawer_layout), "Report all time", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        } else if (id == R.id.nav_export) {
            Snackbar.make(findViewById(R.id.drawer_layout), "Export the report", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        }
